    ...
    for m in list_M:
        ...
        for U in list_U:
           ...
           # plot_stat('PMF_Uniform_Stairs.pdf', 'U', 'Probability')
            ...
            put_on_plot(Bs, {'no temper (uniform)': stat_uni, 'slightly tempered': stat_temper,
                        'medium tempered': stat_mid_temper, 'heavily tempered': stat_easy_temper})

            plot_stat('algo_S.pdf', 'Bins',
                      'Empirical Total Variation Error')

            put_on_plot(Bs, {'no temper (uniform)': stat_uni_baseline, 'slightly tempered': stat_temper_baseline,
                         'medium tempered': stat_mid_temper_baseline, 'heavily tempered': stat_easy_temper_baseline})
